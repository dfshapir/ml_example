...
# kap -- in this case, kap shows how much better you did than a random model. Accuracy gives the percentage that the estimator correctly predicts the output. You can change out predictor variables (party, gender + party, etc.) and run the same code.
```
